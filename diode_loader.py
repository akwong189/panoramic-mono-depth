...
def load_color(filename, path="/data3/awong/diode/", flip=False, shape=(256, 640), rand_shape=(0,0), **kwargs):
...
def load_depth(depth_map, mask, path="/data3/awong/diode/", flip=False, shape=(256, 640), rand_shape=(0,0), **kwargs):
